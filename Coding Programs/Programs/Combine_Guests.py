...
# Each dictionary is a partial list, but Rory's list has more current information about t
# he number of guests. Fill in the blanks to combine both dictionaries into one, with each 
# friend listed only once, and the number of guests from Rory's dictionary taking precedence, 
